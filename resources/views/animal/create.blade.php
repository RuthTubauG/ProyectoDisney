...
@section('content')
        <h2 class="titulo">Añade un personaje</h2>
    ...
    <form action="{{ route('animal.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="txtRaza" placeholder="Tipo" name="txtRaza">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="txtImagen" placeholder="Imagen" name="txtImagen">
        </div>
